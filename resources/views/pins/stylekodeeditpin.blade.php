                            ...
                            <div class="mt-5" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <form method="POST" action="{{ route('pins.update', ['device' => $pin->device->uuid, 'pin' => $pin->uuid]) }}" id="pinSettingsForm">
                                    ...
                                    <div class="card settings-card mb-4">
                                        <div class="card-body">
                                            <h6 class="card-title mb-4">Schedule Settings</h6>
                                            
                                            <div class="mb-4">
                                                <div class="form-check mb-3">
                                                    <input type="checkbox" class="form-check-input" id="enable_schedule" 
                                                ...
                                                <div id="scheduleSettings" class="{{ isset($pin->settings['schedule']['enabled']) && $pin->settings['schedule']['enabled'] ? '' : 'd-none' }}">
                                                    <!-- Start Time -->
                                                    <div class="mb-3">
                                                    ...
                                                    <!-- ON Duration -->
                                                    <div class="mb-3">
                                                        <label for="on_duration" class="form-label">ON Duration (minutes)</label>
                                                        <div class="input-group input-group-custom">
                                                            <span class="input-group-text">
                                                    ...
                                                    <!-- Cycle Interval -->
                                                    <div class="mb-3">
                                                        <label for="cycle_interval" class="form-label">Cycle Interval (minutes)</label>
                                                        <div class="input-group input-group-custom">
                                                            <span class="input-group-text">
                                                    ...
                                                    <!-- Cycle Duration -->
                                                    <div class="mb-3">
                                                        <label for="cycle_duration" class="form-label">Cycle Duration (minutes)</label>
                                                        <div class="input-group input-group-custom">
                                                            <span class="input-group-text">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input" 
                                                                id="repeat_schedule" 
                                                                name="settings[schedule][repeat]"
                                                                {{ isset($pin->settings['schedule']['repeat']) && $pin->settings['schedule']['repeat'] ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="repeat_schedule">
                                                            Repeat Schedule
                                                        </label>
                                                    </div>
                                                </div>
...
function submitForm(event) {
    ...
    // Basic validation
    const scheduleEnabled = document.getElementById('enable_schedule').checked;
    if (scheduleEnabled) {
